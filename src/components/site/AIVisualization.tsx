...
const modules = [
  { id: 1, title: "Live Feeds", icon: Camera, x: "20%", y: "25%", delay: 0, stats: { stat1: "4,021", label1: "Active Cams", stat2: "12ms", label2: "Latency" } },
  { id: 2, title: "Object Detection", icon: ScanLine, x: "75%", y: "20%", delay: 0.2, stats: { stat1: "99.9%", label1: "Accuracy", stat2: "850/s", label2: "Objects" } },
  { id: 3, title: "Threat Analysis", icon: Crosshair, x: "80%", y: "65%", delay: 0.4, stats: { stat1: "Level 4", label1: "Defcon", stat2: "Active", label2: "Tracking" } },
  { id: 4, title: "Behaviour Scoring", icon: Activity, x: "50%", y: "85%", delay: 0.6, stats: { stat1: "92.4", label1: "Avg Score", stat2: "Nominal", label2: "Status" } },
  { id: 5, title: "Alert Engine", icon: ShieldAlert, x: "20%", y: "70%", delay: 0.8, stats: { stat1: "0", label1: "Critical", stat2: "14", label2: "Warnings" } },
];
...
export function AIVisualization() {
  ...
  // Increased rotation values for a deeper 3D feel
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/20 via-[#020817] to-cyan-900/20 mix-blend-screen pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] bg-cyan-500/5 blur-[120px] rounded-full pointer-events-none" />
